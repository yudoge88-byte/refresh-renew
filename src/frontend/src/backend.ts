...
export class Backend implements backendInterface {
    ...
    async getAllRequests(): Promise<Array<QuoteRequest>> {
    ...
    async getRequestByIndex(arg0: bigint): Promise<QuoteRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestByIndex(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQuoteRequest(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitQuoteRequest(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
